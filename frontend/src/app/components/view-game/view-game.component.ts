    ...
    this.gamer
      ...
      .subscribe((data: any) => {
        ...
        if (test < 1) {
            ...
            (res: any) => {
              ...
              this.gamer
                ...
                .subscribe(async (data: any) => {
                  ...
                  this.toast.success({detail:"Added", summary:'Game added to favorites',position:'tr',duration:2000})
          ...
          this.toast.warning({detail:"Oops!", summary:'Already added to favorites',position:'tr',duration:2000})
